...
class Product(
    ...
    def pre_save(cls, sender, document, **kwargs):
        ...
        document.detect_product_type(
            document
        )

        if document.price.selling_price is None:
            document.price.selling_price = Price.fromstring(
                document.price.raw_selling_price
            ).amount_float
    ...
    def detect_product_type(self, document):
        ...
        meat_alternative_keywords =  plant_based_keywords.union({'tofu', 'plant-based protein', 'vegan sausage', 'meat substitute', "non-dairy", "meatless", "dairy-free", "egg-free", "nut-based", "legume-based", "tofu", "seitan", "tempeh", "plant proteins", "plant-derived", "meat alternative", "egg alternative", "meat-free", "soy-based", "gluten-free", "grain-based", "non-animal", "conscious consumption", "sustainable food", "no animal-derived ingredients", "chickpea-based", "nutritional yeast", "mycroprotein", "fruit-based", "whole grain", "no added hormones", "chia seeds", "flax seeds", "algae-based", "no animal by-products"})
        ...
        elif any(keyword in product_context for keyword in dairy_keywords):
            document.product_type = ProductType.DAIRY
        elif any(keyword in product_context for keyword in meat_alternative_keywords):
