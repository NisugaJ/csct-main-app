...
class Product(Document):
    ...
    def update_product_type(sender, document, **kwargs):
        product_name = document.product_name.lower().join(document.ingredients.lower())

        plant_based_keywords = set(["vegan", "plant-based", "vegetarian", "cruelty-free", "non-dairy", "meatless",
