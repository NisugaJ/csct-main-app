...
from scraper.components.supermarketscraper.supermarketscraper import settings
from scraper.components.supermarketscraper.supermarketscraper.spiders.scraper import AsdaSpider
